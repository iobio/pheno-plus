  ...
  <div id="the-main-container">
    <div id="loading-overlay" :class="{ hidden: hideOverlay }">
      <div id="spinner-container">
        ...
        >
          <path
            d="M 50,6 A 50,50 0 0,1 85.36,35.36"
            fill="none"
            stroke="#1B5590"
            stroke-width="9"
          />
    ...
    <div id="selector-view-container" :class="{ closed: !selectorViewOpen }">
      ...
      >
        <h3
          @mouseenter="showNotesPulledTip = true"
          @mouseleave="showNotesPulledTip = false"
          id="item-selector-header"
        >
        ...
        <button
          class="process-btn all"
          @click="processTextAll"
          :disabled="checkForChecked() || allNotesProcessed"
        >
      ...
      <div
        class="open-close note-preview"
        @click="noteContentOpen = !noteContentOpen"
        v-if="selectorViewOpen"
      >
        <div class="open-close-label">
      ...
      if (gru_data) {
        ...
        for (let key in clinPhen) {
          if (this.hpoTermsObj[key]) {
            ...
            this.hpoTermsObj[key].addToNotesPresentIn([
